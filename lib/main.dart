        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              //   'asdfasdfasdfasd',
              //   style: TextStyle(
              //       fontFamily: "JetBrainsMono", fontSize: 14, height: 1.3),
              // ),
              Container(
                color: Colors.black,
                child: SingleChildScrollView(
                  ...
                  child: IntrinsicWidth(
                    stepWidth: _controlador.text.isEmpty
                    ...
                    child: IntrinsicHeight(
                      child: ConstrainedBox(
                        ...
                        child: TextField(
                          onChanged: (value) {
                            int cursorPosition =
                                _controlador.selection.baseOffset;
                            String text = _controlador.text;
                            int lineNumber = text
                                .substring(0, cursorPosition)
                                .split('\n')
                                .length;
                            print('El cursor está en la línea: $lineNumber');
                            setState(() {});
                          },
                          onTap: () {
                            int cursorPosition =
